    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(blank=True, choices=[('master', 'Master'), ('operadora', 'Operadora'), ('distribuidora', 'Distribuidora'), ('subdistribuidor', 'subdistribuidor'), ('agencia', 'agencia')], default='agencia', max_length=150, null=True, verbose_name='Rol')),
